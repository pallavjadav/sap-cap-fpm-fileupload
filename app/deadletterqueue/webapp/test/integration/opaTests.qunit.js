...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "deadletterqueue/test/integration/FirstJourney",
    "deadletterqueue/test/integration/DeadOutboxMessagesListJourney",
    "deadletterqueue/test/integration/DeadOutboxMessagesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
